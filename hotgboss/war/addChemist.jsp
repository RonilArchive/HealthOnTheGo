				...
				<div class="btn-group pull-right theme-container" >
					...
					<ul class="dropdown-menu" id="themes">
						...
						<li><a data-value="united" href="#"><i class="icon-blank"></i> United</a></li>
                                                <li><a class="ajax-link" href="moniorChemist.jsp"><i class="icon-plus"></i><span class="hidden-tablet">Monitor Chemist</span></a></li>
                                        </ul>
				</div>
				<!-- theme selector ends -->
				...
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="includeMedicine.jsp"><i class="icon-plus"></i><span class="hidden-tablet">Include Medicine</span></a></li>
                                                ...
                                                <li><a class="ajax-link" href="monitorChemist.jsp"><i class="icon-plus"></i><span class="hidden-tablet">Monitor Chemist</span></a></li></ul>
...
<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="addChemist.jsp">Add Chemist</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-edit"></i>Add Chemist</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="chemist" method="post" action="/insertChemist">
							<fieldset>
							  
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Chemist ID : </label>
								<div class="controls">
								  <input name="chemist_id" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="password" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Chemist Name : </label>
								<div class="controls">
								  <input name="chemist_name" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="address" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                        
                                                            <div class="control-group">
								<label class="control-label" for="selectError1">Street : </label>
								<div class="controls">
								  <select name="street" id="selectError1" data-rel="chosen">
                                                                      <%
										...
										String sql="SELECT distinct City from Street;";
										...
										if(rs.next())
										{
											String tmp=rs.getString(1);
                                                                                       ...
                                                                                       // String val=tmp1+"state";
                                                                                        data+=tmp+"cstat";
											sql="SELECT Station,Street_Name,Street_Id from Street where City = '"+tmp+"';";
											rs1 = statement.executeQuery(sql);
											while(rs1.next())
											{
												String tmp2=rs1.getString(1);
                                                                                                String tmp3=rs1.getString(2);
                                                                                                String tmp4=rs1.getString(3);
                                                                                                data+=tmp2+",";
												String value=tmp+":"+tmp2;
												out.println("<option value='"+tmp4+"'>"+tmp3+"-"+tmp2+"</option>");
											}
                                                                                        data+="citie";
        ...
        %>
                                                            ...
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Station : </label>
								<div class="controls">
								  <input name="station" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="mobile_number" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Alternate Contact Number : </label>
								<div class="controls">
								  <input name="alt_contact_number" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="email_id" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Expiration Date : </label>
								<div class="controls">
								  <input name="expiration_date" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                <p class="help-block">Example : 2014-09-09 00:00:00 </p>
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <label class="radio">
									<input type="radio" name="verification" id="optionsRadios1" value="Yes" checked="">
									YES
								  </label>
								  <div style="clear:both"></div>
								  <label class="radio">
									<input type="radio" name="verification" id="optionsRadios2" value="No">
									NO
								  </label>
								</div>
							  </div>
