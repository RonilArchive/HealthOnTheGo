...
<head>
    ...
    <script>
     function getMedicin(chemid) 
     { 
    var strURL="/getMedicine?chemist_id="+chemid;
   // alert();
     //alert(chemid);
  ...
  if (window.XMLHttpRequest)
            ...
            xmlhttp.onreadystatechange=function()
              ...
              if (xmlhttp.readyState==4 && xmlhttp.status==200)
                ...
                document.getElementById("getMedici").innerHTML=xmlhttp.responseText;
...
<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="includeMedicine.jsp">Include Medicine</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-edit"></i>Include Medicine</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="ex_medicine" method="post" action="/includeMedicineServlet">
							<fieldset>
							 
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="selectError1">Chemist Name : </label>
								<div class="controls" >
                                                                    <select name="chemist_name" id="selectError1" data-rel="chosen" length="70" onchange="getMedicin(this.value)">
                                                                      <%
										...
										String sql="select Chemist_List.Chemist_Id,Chemist_List.Chemist_Name,Street.Street_Name from Chemist_List INNER JOIN Street ON Chemist_List.Street_Id=Street.Street_Id;";
										...
										while(rs.next())
										{
                                                                                    ...
                                                                                    out.println("<option value='"+tmp1+"'>"+tmp2+"-"+tmp3+"</option>");
        ...
        %>
                                                            ...
                                                            <div class="control-group">
								<label class="control-label" for="selectError2">Brand Name : </label>
								<div class="controls" id="getMedici">
                                                                    <select name="brand_name" id="selectError2" data-rel="chosen"  size="70">
                                                                        <option value="">
                                                                    </select>
								</div>
							  </div>
