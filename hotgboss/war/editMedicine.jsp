		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="editMedivine.jsp">Edit Medicine</a>
					</li>
				</ul>
			</div>
			
                        <div class="control-group">
                        <label class="control-label" for="appendedInputButton">Search Medicine</label>
                        <div class="controls">
                          <div class="input-append">
                                <input id="appendedInputButton" size="16" type="text" onkeyup="s">
                          </div>
                        </div>
			</div>
		<hr>
