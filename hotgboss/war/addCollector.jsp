...
<div>
			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-edit"></i>Add Collector</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="street" method="post" action="/insertCollector">
							<fieldset>
							  
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Collector ID : </label>
								<div class="controls">
								  <input name="collector_id" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="first_name" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="last_name" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="email_id" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                            ...
                                                            <div class="control-group">
								<label class="control-label" for="selectError1">Select Street</label>
								<div class="controls">
								  <select name="streets" id="selectError1" multiple data-rel="chosen">
                                                                      <%
        ...
        %>
							  ...
							  <div class="control-group">
								<label class="control-label" for="selectError3">Lab Name : </label>
								<div class="controls">
								  <select name="lab_name" id="selectError3" data-rel="chosen">
                                                                      <%
                                                                      
                                                                                        
											sql="select Lab_Id,Lab_Name,Station from Lab_List;";
											rs1 = statement.executeQuery(sql);
											while(rs1.next())
											{
												String tmp2=rs1.getString(1);
												...
												out.println("<option value='"+tmp2+"'>"+tmp3+"-"+tmp4+"</option>");
											}
                                                                                        %>
