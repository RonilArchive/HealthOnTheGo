			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-edit"></i>Add Lab</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="street" method="post" action="/insertLab">
							<fieldset>
							  
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Lab ID : </label>
								<div class="controls">
								  <input name="lab_id" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Lab Name : </label>
								<div class="controls">
								  <input name="lab_name" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="phone_number" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
								...
								<div class="controls">
								  <input name="alt_phone_number" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
