...
<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="excludeMedicine.jsp">Exclude Medicine</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-edit"></i>Exclude Medicine</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="ex_medicine" method="post" action="/excludeMedicineServlet">
							<fieldset>
								...
								<div class="controls">
                                                                    <select name="chemist_name" id="selectError1" data-rel="chosen"  size="70">
                                                                      <%
        ...
        %>
                                                            ...
                                                            <div class="control-group">
								<label class="control-label" for="selectError2">Drug Name : </label>
								<div class="controls">
                                                                    <select name="brand_name" id="selectError2" multiple data-rel="chosen" size="70" >
                                                                      <%
                                                                      sql="select Drug_Code,Brand_Name,Strength from Central_Inventory;";
									rs = statement.executeQuery(sql);
