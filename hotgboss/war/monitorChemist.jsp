...
<body>
	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="monitorChemist.jsp">Monitor Chemist</a>
					</li>
				</ul>
			</div>
                        ...
                        <%
                            ...
                            Date date = new Date();
                            String dateIST = sdf.format(date);
                            
                            Calendar c = Calendar.getInstance();
                            c.setTime(sdf.parse(dateIST));
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>Ignored Orders</h2>
						<div class="box-icon">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                           ...
                                                           // java.sql.Connection connection = DriverManager.getConnection(connectionURL,"root","root");
                                                            ...
                                                            String sql="select User_Order_Medicine.Order_Id,Chemist_List.Chemist_Name,Chemist_List.Mobile_phone_Number as Chemist_Contact_Number,User.First_Name,User.Last_Name,User.Mobile_phone_number,Order_Time as User_Contact_Number from User_Order_Medicine INNER JOIN User on User_Order_Medicine.User_Id=User.User_Id INNER JOIN Chemist_List ON User_Order_Medicine.Chemist_Id=Chemist_List.Chemist_Id "
                                                                    + "where Order_Time <= '"+dt+"' and User_Order_Medicine.Status like 'OR' group by Order_Id;";
                                                            rs = statement.executeQuery(sql);
                                                           while(rs.next())
                                                           {
                                                               String order_id=rs.getString(1);
                                                               String chemist_name=rs.getString(2);
                                                               String chem_contact=rs.getString(3);
                                                               String username=rs.getString(4)+" "+rs.getString(5);
                                                               String usercon=rs.getString(6);
                                                               String orderTime=rs.getString(7);
                                                               out.println("<tr><td>"+order_id+"</td>"
                                                                       + "<td class=\"center\">"+chemist_name+"</td>"
                                                                       + "<td class=\"center\">"+chem_contact+"</td>"
                                                                       + "<td class=\"center\">"+username+"</td>"
                                                                       + "<td class=\"center\">"+usercon+"</td>"
                                                                       + "<td class=\"center\">"+orderTime+"</td></tr>");
                                                           }
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>Rejected Orders</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
							<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                            ...
                                                            //java.sql.Connection connection = DriverManager.getConnection(connectionURL,"root","root");
                                                            //statement = connection.createStatement();
                                                            sql="select User_Order_Medicine.Order_Id,Chemist_List.Chemist_Name,Chemist_List.Mobile_phone_Number as Chemist_Contact_Number,User.First_Name,User.Last_Name,User.Mobile_phone_number as User_Contact_Number,Order_Time from User_Order_Medicine INNER JOIN User on User_Order_Medicine.User_Id=User.User_Id INNER JOIN Chemist_List ON User_Order_Medicine.Chemist_Id=Chemist_List.Chemist_Id "
                                                                    + "where User_Order_Medicine.Status like 'OJ' group by Order_Id ORDER BY Order_Time desc LIMIT 40;";
                                                            rs = statement.executeQuery(sql);
                                                           while(rs.next())
                                                           {
                                                               String order_id=rs.getString(1);
		...
		<footer>
			...
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">HOTG Cloud</a></p>
		</footer>
