			...
			<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-edit"></i>Add Test</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="medicine" method="post" action="/insertTest">
							<fieldset>
							  
                                                            <div class="control-group">
								<label class="control-label" for="prependedInput">Test ID : </label>
								<div class="controls">
								  <div class="input-prepend">
									<span class="add-on">T</span>
                                                                        <input id="prependedInput" size="16" type="text" name="test_id">
								  </div>
								</div>
							  </div>
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Test Name Generic : </label>
								<div class="controls">
								  <input name="test_name_generic" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                            
                                                            <div class="control-group">
								<label class="control-label" for="focusedInput">Test Name Specific : </label>
								<div class="controls">
								  <input name="test_name_specific" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
                                                            
                                                            
                                                                <div class="control-group">
								<label class="control-label" for="focusedInput">Test Precursor : </label>
								<div class="controls">
								  <input name="test_precursor" class="input-xlarge focused" id="focusedInput" type="text" value="">
                                                                </div>
                                                                </div>
