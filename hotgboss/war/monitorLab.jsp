		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="monitorLab.jsp">Monitor Lab</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>All Orders</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
                                                            ...
                                                            String sql="select Order_Id_Test,User.First_Name,User.Last_Name,Collection_Agent_List.First_Name,Collection_Agent_List.Last_Name,Collection_Agent_List.Mobile_Phone_Number,Appointment_Date,Appointment_Time,TestStatus,Entry_Timestamp from User_Order_For_Test INNER JOIN User"
                                                                    + " on User_Order_For_Test.User_Id=User.User_Id INNER JOIN Collection_Agent_List ON Collection_Agent_List.Collector_Id=User_Order_For_Test.Collector_Id order by Entry_Timestamp desc;";
                                                           ...
                                                           while(rs.next())
                                                           {
                                                               ...
                                                               String collector_name=rs.getString(4)+" "+rs.getString(5);
                                                               String collector_mob_no=rs.getString(6);
                                                               String app_time=rs.getString(7)+" "+rs.getString(8);
                                                               String testStatus=rs.getString(9);
                                                               String entryTime=rs.getString(10);
                                                               out.println("<tr><td>"+order_id+"</td>"
                                                                       + "<td class=\"center\">"+username+"</td>"
                                                                       + "<td class=\"center\">"+collector_name+"</td>"
                                                                       + "<td class=\"center\">"+collector_mob_no+"</td>"
                                                                       + "<td class=\"center\">"+app_time+"</td>");
                                                               if(testStatus.equals("OA"))
                                                                       out.println("<td class=\"center\">Accepted</td>");
                                                               else if(testStatus.equals("OR"))
                                                                   out.println("<td class=\"center\">Pending</td>");
                                                               else if(testStatus.equals("OJ"))
                                                                   out.println("<td class=\"center\">Rejected</td>");
                                                               out.println("<td class=\"center\">"+entryTime+"</td></tr>");
                                                           }
