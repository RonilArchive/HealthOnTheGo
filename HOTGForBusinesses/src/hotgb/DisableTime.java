...
public class DisableTime extends HttpServlet{
		...
		String TimeML=request.getParameter("TimeML");
		 ...
		 try {
	            ...
	            try {
	            	 ...
	            	 String statement = "Delete from Collection_Agent_Datetime_Mapping where Collector_Id like '"+CollectorID+"' and Appointment_Date like '"+DateML+"' and Appointment_Time like '"+TimeML+"' and Booked like 'No'";
